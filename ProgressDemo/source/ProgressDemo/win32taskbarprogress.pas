...
2024-05: Added SetOverlayIcon (Thorsten Eggeling)
...
uses
  SysUtils, ShlObj, ComObj, InterfaceBase, Forms,Windows, Graphics;
...
type
  ...
  private
    ...
    procedure SetOverlayIcon(const AIcon:TIcon);
  ...
  public
    ...
    property Icon: TIcon read FIcon write SetOverlayIcon;
  end;
...
procedure TWin7TaskProgressBar.SetOverlayIcon(const AIcon: TIcon);
begin
 if (FIntf <> nil) and (FHandle <> 0) then
 begin
  FIcon := AIcon;
  If FIcon=nil then
  FIntf.SetOverlayIcon(FHandle,0,'')
  else
